      ...
      <h1>Demographics</h1>
        <form className="form">
          ...
          <div className="form-group">
            ...
            <input type="number" id="eid" name="eid" value={formData.eid} onChange={handleChange} />
          </div>
          <div className="form-group">
          ...
          <div className="form-group">
            ...
            <input type="text" id="faname" name="faname" value={formData.faname} onChange={handleChange} />
          </div>
          <div className="form-group">
            <label htmlFor="mname">Mother Name:</label>
            <input type="text" id="mname" name="mname" value={formData.mname} onChange={handleChange} />
          </div>
          <div className="form-group">
...
<div className="form-group">
  ...
  <select id="sunExposure" name="sunExposure" value={selectedIdentifierData.sunExposure ? selectedIdentifierData.sunExposure : ''} onChange={handleChange}>
    <option value="">Select...</option>
    <option value="Yes">Yes</option>
    <option value="No">No</option>
    <option value="Unknown">Unknown</option>
...
<div className="form-group">
  ...
  <select id="mentalHealth" name="mentalHealth" value={selectedIdentifierData.mentalHealth ? selectedIdentifierData.mentalHealth : ''} onChange={handleChange}>
    <option value="">Select...</option>
    <option value="Yes">Yes</option>
    <option value="No">No</option>
    <option value="Unknown">Unknown</option>
...
<div className="form-group">
  ...
  <select id="mood" name="mood" value={selectedIdentifierData.mood ? selectedIdentifierData.mood : ''} onChange={handleChange}>
    <option value="">Select...</option>
    <option value="Yes">Yes</option>
    <option value="No">No</option>
    <option value="Unknown">Unknown</option>
  ...
  {allForms.map (form => (
    <option key={form.identifier} value={form.identifier}>{form.identifier}</option>
          ...
          <div className="form-group">
            ...
            <select id="systolic" name="systolic" value={selectedIdentifierData.systolic} onChange={handleChange}>
              <option value="">Select...</option>
          ...
          <div className="form-group">
            ...
            <select id="diastolic" name="diastolic" value={selectedIdentifierData.diastolic} onChange={handleChange}>
              <option value="">Select...</option>
